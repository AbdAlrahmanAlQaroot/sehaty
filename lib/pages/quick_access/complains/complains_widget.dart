...
import 'complains_model.dart';
export 'complains_model.dart';
...
class _ComplainsWidgetState extends State<ComplainsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComplainsModel());
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 50.0, 0.0, 0.0),
                                                child: Lottie.asset(
                                                  'assets/lottie_animations/Animation_-_1695818058614_(1).json',
                                                  width:
