      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DoctorsWidget(
            speciality: params.getParam('speciality', ParamType.String),
            name: params.getParam('name', ParamType.String),
          ),
        ),
        FFRoute(
          ...
          path: '/chatGPT',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ChatGPT')
              : ChatGPTWidget(),
        ),
        FFRoute(
          name: 'notifications',
        ...
        FFRoute(
          ...
          builder: (context, params) => PrescriptionMedicineWidget(),
        ),
        FFRoute(
          name: 'settings',
          path: '/settings',
        ...
        FFRoute(
          name: 'xray',
          path: '/xray',
          builder: (context, params) => XrayWidget(),
        ),
        FFRoute(
          name: 'calendar',
          path: '/calendar',
